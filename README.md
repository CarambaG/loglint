...
`loglint` - это кастомный линтер для Go, интегрируемый в golangci-lint. Он проверяет лог-записи библиотек `log`, `slog` и `zap` на соблюдение корпоративных правил: стиль сообщений, язык, отсутствие спецсимволов и чувствительных данных.
